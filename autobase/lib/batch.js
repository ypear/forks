class MemberBatch {
  ...
  async commit () {
    ...
    if (this.batchId !== this.autobase._batchId) {
      console.log('autobase/lib/batch.js', this.batchId, this.autobase._batchId);
      throw new Error('Batch is out-of-date. Did you commit another batch in parallel?')
    }
